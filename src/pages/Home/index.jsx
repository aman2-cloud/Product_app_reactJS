...
const Home = () => {
    ...
    const handleChangeChecked=(id)=>{
        ...
        const changeCheckedCusines=cusinesStateList.map(item=>item.id===id?{...item,checked:!item.checked}: item);
    ...
    const cusineChecked=cusines.filter(item=>item.checked).map(item=>item.label.toLowerCase());
    if(cusineChecked.length){
        updatedList=updatedList.filter(item=>cusineChecked.includes(item.cuisine));
    }
